    ...
    <Link className="food-box" to={'/menu/'+food.RecipesID} style={{textDecoration:"none"}}>
        ...
        <div className="food-info">
            ...
            <div className="f-info" style={{margin:"6px 0 8px 0"}}>
                ...
                <div style={{color:"rgb(170,5,5)"}}><strong>{food.OverallRating>0?(food.OverallRating*100)%100>0?food.OverallRating.toFixed(2):(food.OverallRating*10)%10>0?food.OverallRating.toFixed(1):food.OverallRating:0}</strong></div>
