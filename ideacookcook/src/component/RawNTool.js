...
const Tools=(props)=> {
    ...
    <div style={{display:"flex",flexDirection:"row"}}>        
        ...
        <div className="RNT" style={{width:"250px"}}>
            ...
            <div className="div" style={{maxWidth:"170px",wordWrap:"break-word",textAlign:"center"}}>{tool}</div>
...
const Raws=(props)=> {
    ...
    <div style={{display:"flex",flexDirection:"row"}}>        
        ...
        <div className="RNT">
            <div className="index">{index+1}</div>
            <div className="div" style={{maxWidth:"120px",wordWrap:"break-word"}}>{raw.RawFood}</div>
            <div className="div" style={{maxWidth:"70px",textAlign:"center"}}>{raw.Quantity}</div>
            <div className="div" style={{maxWwidth:"100px",textAlign:"right"}}>{raw.Unit}</div>
        </div>
    </div>
